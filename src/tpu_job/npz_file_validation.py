...
VALIDATION_CORE_ID = 2     # The TPU Core ID that saved the file (e.g., core_10)
VALIDATION_CHUNK_INDEX = 29  # The chunk index of the file you want to validate (e.g., embeddings_chunk_1.npz)
